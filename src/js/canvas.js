...
function init() {
  platformImage = createImage(platform)
    ...
    player = new Player()
    platforms =[ 
                new Platform({x:platformImage.width * 4 + 300 - 2 + platformImage.width - platformSmallTallImage.width,  y:300,
                image: platformSmallTallImage
                 }),
        
                new Platform({x: -1, y: 500,image:platformImage}), 
                  new Platform({x:platformImage.width -3, y:500, image: platformImage}),
                  new Platform({x:platformImage.width * 2 +100, y:500, image: platformImage}),
                  new Platform({x:platformImage.width * 3 + 300, y:500, image: platformImage}),
                  new Platform({x:platformImage.width * 4 + 300 - 2, y:500, image: platformImage}),
                  new Platform({x:platformImage.width * 5 + 700 - 2, y:500, image: platformImage})
